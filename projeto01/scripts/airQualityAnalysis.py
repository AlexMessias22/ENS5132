# -*- coding: utf-8 -*-
"""
Created on Tue Apr  8 13:05:34 2025
...
def airQualityAnalysis(uf):
    ...
    dataDir = r"C:\Users\junih\Documents\ENS5132\projeto01\inputs" +'/'+ uf
    ...
    os.makedirs(r'C:\Users\junih\Documents\ENS5132\projeto01\outputs'
                     +'/'+uf,exist_ok=True)
    ...
    # Salvando em csv
    statGroup.to_csv(r'C:\Users\junih\Documents\ENS5132\projeto01\outputs'
