...
dados = pd.read_csv('INMET_S_SC_A806_FLORIANOPOLIS_01-01-2024_A_31-12-2024.CSV', skiprows=8, delimiter= ";", encoding='latin1',
                    decimal = ',')

# ------ 1.2 Variáveis meteorológicas analisadas
var_meteo = ['PRECIPITAÇÃO TOTAL, HORÁRIO (mm)', 'PRESSAO ATMOSFERICA AO NIVEL DA ESTACAO, HORARIA (mB)',
